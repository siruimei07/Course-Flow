...
test('isBootstrapOutcome accepts only complete path-free states correlated to its request and build', () => {
  ...
  for (const workspaceData of [
    ...
    },
    {
      ...
      problem: {
        ...
        allowedActions: [],
        context: {},
        details: { actualSchemaLevel: 2, requiredSchemaLevel: 10 },
      },
    },
    {
      kind: 'recovery',
  ...
  for (const value of [
    ...
    {
      ...validOutcome,
      value: { ...validOutcome.value, workspaceData: { kind: 'ready', workspaceId, schemaLevel: 10, revision: '01' } },
    },
    {
      ...validOutcome,
      ...
      value: {
        ...
        workspaceData: {
          ...
          problem: {
            ...
            allowedActions: [],
            context: {},
            details: { actualSchemaLevel: 10, requiredSchemaLevel: 10 },
          },
        },
      },
    },
    {
      ...
      value: {
        ...validOutcome.value,
        workspaceData: { kind: 'read-only', workspaceId, schemaLevel: 10, revision: 42n, problem: {} },
      },
    },
