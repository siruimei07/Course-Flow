...
test('isBootstrapOutcome accepts only complete path-free states correlated to its request and build', () => {
  ...
  for (const workspaceData of [
    ...
    },
    {
      ...
      problem: {
        ...
        allowedActions: [],
        context: {},
        details: { actualSchemaLevel: 2, requiredSchemaLevel: 12 },
      },
    },
    {
      kind: 'recovery',
  ...
  for (const value of [
    ...
    {
      ...validOutcome,
      value: { ...validOutcome.value, workspaceData: { kind: 'ready', workspaceId, schemaLevel: 12, revision: '01' } },
    },
    {
      ...validOutcome,
      ...
      value: {
        ...
        workspaceData: {
          ...
          problem: {
            ...
            allowedActions: [],
            context: {},
            details: { actualSchemaLevel: 12, requiredSchemaLevel: 12 },
          },
        },
      },
    },
    {
      ...
      value: {
        ...validOutcome.value,
        workspaceData: { kind: 'read-only', workspaceId, schemaLevel: 12, revision: 42n, problem: {} },
      },
    },
